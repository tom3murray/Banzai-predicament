...
# Apply the desired seaborn style
sns.set_style("dark")

# Plot the accuracy graph
plt.figure()
plt.plot(history.history['accuracy'], color ="crimson", label='Training accuracy')
plt.plot(history.history['val_accuracy'], color="turquoise", label='Validation accuracy')
plt.xlabel('Epoch')
plt.ylabel('Accuracy')
...
# Plot the loss graph
plt.figure()
plt.plot(history.history['loss'],color ="crimson", label='Training loss')
plt.plot(history.history['val_loss'],color="turquoise", label='Validation loss')
plt.xlabel('Epoch')
plt.ylabel('Loss')
